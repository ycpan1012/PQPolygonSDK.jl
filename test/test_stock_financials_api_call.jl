...
endpoint_options["company_name"] = "N/A"
endpoint_options["sic"] = "N/A"
endpoint_options["filing_date"] = "N/A"
endpoint_options["period_of_report_date"] = "N/A"
endpoint_options["timeframe"] = "N/A"
endpoint_options["include_sources"] = "N/A"
endpoint_options["order"] = "N/A"
endpoint_options["limit"] = "N/A"
endpoint_options["sort"] = "N/A"

endpoint_model = model(PolygonStockFinancialsEndpointModel, user_model, endpoint_options)
...
# make the call -
(header, data) = api(PolygonStockFinancialsEndpointModel, my_url_string)
